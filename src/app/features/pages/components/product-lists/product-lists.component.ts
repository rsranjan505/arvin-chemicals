...
export class ProductListsComponent {
  ...
  products = [
    ...
    },
    {
      ...
      images: [
        '/assets/products/forever24.png',
        '/assets/products/forever22.png',
        '/assets/products/forever23.png',
      ],
    },
    {
      ...
      images: [
        '/assets/products/magnesium.png',
        '/assets/products/magnesium2.png',
        '/assets/products/magnesium3.png',
      ],
    },
          {
        ...
        capsule: 60,
        rating: 4.5,
        img: '/assets/products/mens_multivitamin.png',
      ...
      },
      {
        ...
        capsule: 120,
        rating: 4.4,
        img: '/assets/products/potassium_citrate.png',
      ...
      },
      {
        ...
        capsule: 60,
        rating: 4.6,
        img: '/assets/products/selenium_plus.png',
      ...
      },
      {
        ...
        capsule: 120,
        rating: 4.7,
        img: '/assets/products/vitamin_B1_thiamine.png',
      ...
      },
      {
        ...
        capsule: 60,
        rating: 4.3,
        img: '/assets/products/weightwise_burner_pro_advanced.png',
      ...
      },
      {
        ...
        capsule: 60,
        rating: 4.5,
        img: '/assets/products/alpha_lipoic_acid.png',
      ...
      },
      {
        ...
        capsule: 60,
        rating: 4.6,
        img: '/assets/products/berberine.png',
      ...
      },
      {
        ...
        capsule: 60,
        rating: 4.8,
        img: '/assets/products/biotinplus.png',
      ...
      },
      {
        ...
        capsule: 120,
        rating: 4.4,
        img: '/assets/products/chromium_picolinate.png',
      ...
      },
      {
        ...
        capsule: 120,
        rating: 4.5,
        img: '/assets/products/melatonin.png',
      ...
      },
      {
        ...
        capsule: 90,
        rating: 4.7,
        img: '/assets/products/curcumin_with_bioperine.png',
      ...
      },
      {
        ...
        capsule: 60,
        rating: 4.8,
        img: '/assets/products/fish_oil_capsules_omega_3.png',
      ...
      },
      {
        ...
        capsule: 90,
        rating: 4.4,
        img: '/assets/products/glucosamine_chondroitin.png',
      ...
      },
      {
        ...
        capsule: 120,
        rating: 4.5,
        img: '/assets/products/l_arginin.png',
      ...
      },
      {
        ...
        capsule: 60,
        rating: 4.6,
        img: '/assets/products/liver_plus.png',
